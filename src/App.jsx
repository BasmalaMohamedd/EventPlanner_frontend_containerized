...
const API_BASE_URL = "https://backend-route-crt-20226011-dev.apps.rm3.7wse.p1.openshiftapps.com";
...
function App() {
  ...
  useEffect(()=>{
    ...
    if(token)
    {
      fetch('https://backend-route-crt-20226011-dev.apps.rm3.7wse.p1.openshiftapps.com/users/login/token', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${token}`
